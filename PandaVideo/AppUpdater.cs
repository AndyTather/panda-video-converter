...
// Updated for Pandasoft Video requirements
//
// ------------------------------------------------------------------
//
...
namespace Ionic.AppUpdater.Wpf
{
    /// <summary>
    ...
    public class Updater
    {
        ...
        /// <summary>
        /// The XML for the public key used to verify the downloaded image.
        /// </summary>
        /// <remarks>
        /// This should be set at compile-time by the author of the application to be updated.
        /// It is the public half of a keypair generated from the sn.exe tool.
        /// </remarks>
        ...
        //    String filename = Path.GetFileName(_AppLatestImageUrl);
        //    string tmpExe = filename;
        ...
        private bool DownloadWorker2(string url, string imageName, int imageSize)
        {
            ...
            cancelAction = false;
            using (Stream s1 = new FileStream(imageName, FileMode.Create))
            {
...
//            }
        ...
        private bool VerifyHash(string imageName)
        {
            ...
            if (!System.IO.File.Exists(imageName)) return false;
            byte[] computedHash = ComputeHash(imageName);

            return (ByteArrayToString(computedHash) == ByteArrayToString(_info.Hash));
        }
        ...
        private void Button1_Click(object sender, RoutedEventArgs e)
        {
            if ((string)button1.Content == "Get Update")
            {
                ...
                {
                    string tmpMsi = Path.Combine(Path.GetTempPath(), Path.GetFileName(_AppLatestImageUrl));
                    try
                    {
                        StartDownloadImage(_AppLatestImageUrl, tmpMsi);
                    }
                    catch (Exception ex1)
                    {
                        _status.Success = false;
        ...
        <Controls:MetroWindow
              ...
              Title   = 'Pandasoft Updater' 
              Height  = '260'
              Width   = '380'
              MinHeight  = '260'
              MinWidth   = '380'
              Icon='/PandaVideo;component/PandaVideo.ico' 
                BorderThickness='1' 
            ...
            <Grid>
                <Grid.RowDefinitions>
                    ...
                    <StackPanel Grid.Row='0' Margin='8,8,8,8'>
                        ...
                        <TextBlock Name='textBlock4'>For further information and release notes browse to</TextBlock>
                        <TextBlock>
